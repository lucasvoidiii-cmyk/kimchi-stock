...
ko:{mn:['1월','2월','3월','4월','5월','6월','7월','8월','9월','10월','11월','12월'],
  ...
  stOk:'정상',stWarn:'여유 부족',stDanger:'재발주 필요',stZero:'품절',stBackorder:'선판매 중',
...
vi:{mn:['T1','T2','T3','T4','T5','T6','T7','T8','T9','T10','T11','T12'],
  ...
  stOk:'Bình thường',stWarn:'Sắp hết',stDanger:'Cần đặt hàng',stZero:'Hết hàng',stBackorder:'Đặt trước',
